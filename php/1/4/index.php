...
<main class="main_head">
    ...
    <div class="div_main">В PHP коде <b>комментарии</b> являются строкой, которая не выполняется как часть программы. Вы можете использовать комментарии, чтобы общаться с другими программистами, чтобы они могли понять, что вы сделали, или в качестве напоминания для вас, что сделаил вы.<br><br>
